...
CRITICAL RULES:
- Convert EACH spoken word to EXACTLY ONE digit:
  zero=0, one=1, two=2, three=3, four=4, five=5, six=6, seven=7, eight=8, nine=9
- Count the digit words: "zero zero zero zero" = exactly 4 zeros (0000), NOT 5
- The number of digits in output MUST equal the number of digit words spoken
- Exception: "six zeros" means 6 zeros (000000), "four zeros" means 4 zeros (0000)
- Keep letters as uppercase (H, L, A, etc.)
- Keep dashes only if speaker says "dash" or "hyphen"
- Ignore filler words and punctuation

Example: "three two one four six zero zero zero zero" has 9 digit words:
three=3, two=2, one=1, four=4, six=6, zero=0, zero=0, zero=0, zero=0
Result: 321460000 (9 digits)
